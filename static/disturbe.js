...
sendHello = function(transientKeys, success, error) {
  ...
  return $.ajax({
    ...
    success: function(data, status, xhr) {
      ...
      cookie = JSON.parse(decodeUTF8(nacl.crypto_box_open(cookie_box_cipher, cookie_box_nonce, serverPublicKey, transientKeys.secretKey)));
...
sendInitiate = function(userKeys, transientKeys, serverTPKey, cookie, message, success, error) {
  ...
  transientKeyBox = nacl.crypto_box(transientKeys.publicKey, transientKeyNonce, serverPublicKey, userKeys.secretKey);
  ...
  vouchBox = nacl.crypto_box(vouchBuffer, vouchNonce, serverTPKey, transientKeys.secretKey);
  ...
  return $.ajax({
    ...
    success: function(data, status, xhr) {
      ...
      response = decodeUTF8(nacl.crypto_box_open(response_box_cipher, response_box_nonce, serverTPKey, transientKeys.secretKey));
