    ...
    return form({
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        ...
        _results.push(span({
          ...
          onClick: (function(file) {}).bind(this, file)
        }));
      }
      return _results;
    }).call(this))));
