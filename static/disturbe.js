  ...
  DisturbeApp = React.createClass({
    ...
    render: function() {
      return div(null, this.state.userKeys != null ? div(null, h1({
        ...
        className: 'text-monospace'
      }, 'Anyone who has your curve ID can send messages that only you can decrypt.'), p({
        className: 'text-monospace'
      }, 'Spread your curve ID wide. The secret key you should never reveal.'))), CurveProfile({
        userKeys: this.state.userKeys
      }), div({
        className: 'row'
      }, div({
        className: 'col-md-12'
      }, hr(null, EncryptMessage({
        userKeys: this.state.userKeys
      }))), div({
        className: 'col-md-12 large-bottom'
      }, hr(null, DecryptMessage({
        userKeys: this.state.userKeys
      }))))) : div({
        className: 'row'
      }, div({
        className: 'col-md-10 col-md-offset-1 large-bottom'
      }, h1({
        className: 'text-monospace large-bottom'
  ...
  EncryptMessage = React.createClass({
    ...
    render: function() {
      return div(null, div({
        ...
        className: 'text-monospace'
      }, 'Compose an encrypted message'), p({
        className: 'text-monospace'
      }, 'Only the owners of the public keys you specify will be able to decrypt it.'))), this.state.ciphertext == null ? ComposeMessage({
  ...
  DecryptMessage = React.createClass({
    ...
    render: function() {
      return div(null, div({
        ...
        className: 'text-monospace'
      }, 'You can only decrypt a message that was encrypted for your curve ID.'))), this.state.plaintext == null ? form({
        className: 'form-horizontal'
  ...
  PublicKeyField = React.createClass({
    ...
    render: function() {
      ...
      return div({
        ...
        className: 'control-label text-monospace',
        style: {
          fontSize: '1.3em',
          marginTop: '0em'
        }
  ...
  GeneratePrivateKey = React.createClass({
    ...
    render: function() {
      ...
      return div({
        ...
        className: "text-monospace"
      }, 'Derive your curve ID'), p({
        className: "text-monospace"
      }, "Your email and password are used to generate a unique pair of keys."), p({
        className: "text-monospace"
      }, "The credentials do not leave your device and are never stored."))), div({
        style: {
          marginTop: "1em"
        }
      }, InputField({
        ...
        className: 'btn btn-lg btn-default pull-right text-monospace',
        onClick: this.generateKey
  ...
  VerifyPassword = React.createClass({
    ...
    render: function() {
      ...
      return div(null, div({
        ...
        className: 'text-monospace'
      }, "Your password needs to have high entropy to generate high quality keys."))), div({
        style: {
          marginBottom: "1em"
        }
      }, InputField({
  ...
  InputField = React.createClass({
    ...
    render: function() {
      ...
      return div({
        ...
        className: 'input-group input-group-lg margin-bottom-lg'
      }, span({
