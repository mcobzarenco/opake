(function() {
  var BOX_NONCE_BYTES, CIPHER_DECRYPT_INFO_FIELD, CIPHER_MESSAGE_FIELD, CIPHER_TRANSIENT_PKEY_FIELD, CIPHER_VERSION, CIPHER_VERSION_FIELD, CiphertextArea, CiphertextAreaClass, ComposeMessage, ComposeMessageClass, CryptoTabPicker, CryptoTabPickerClass, DECRYPT_INFO_MESSAGE_INFO_FIELD, DECRYPT_INFO_SENDER_FIELD, DISTURBE_PROTO, DecryptMessage, DecryptMessageClass, DisturbeApp, DisturbeAppClass, EncryptMessage, EncryptMessageClass, FileSelect, FileSelectClass, GeneratePrivateKey, GeneratePrivateKeyClass, HELLO_CLIENT_TRANSIENT_PKEY_FIELD, HELLO_PADDING_BYTES, HELLO_PADDING_FIELD, HELLO_URL, HELLO_ZEROS_BOX_FIELD, INITIATE_CLIENT_TRANSIENT_PKEY_FIELD, INITIATE_COOKIE_FIELD, INITIATE_URL, INITIATE_VOUCH_FIELD, InputField, InputFieldClass, KEY_BASE64_BYTES, KeyProfile, KeyProfileClass, KeyProfileItem, KeyProfileItemClass, MESSAGE_INFO_KEY_FIELD, MESSAGE_INFO_NONCE_FIELD, MINIMUM_PASSWORD_ENTROPY_BITS, MessageView, MessageViewClass, OpakeProfile, OpakeProfileClass, PublicKeyField, PublicKeyFieldClass, RemoteMessaging, RemoteMessagingClass, SCRYPT_L, SCRYPT_N, SCRYPT_P, SCRYPT_R, SERVER_DOMAIN_NAME, SERVER_PUBLIC_KEY, STRONG_PASSWORD_ENTROPY_BITS, SecretKeyField, SecretKeyFieldClass, TAB_CLOUD, TAB_DECRYPT, TAB_ENCRYPT, TIPJAR_ADDRESS, Tipjar, TipjarClass, VOUCH_CLIENT_PKEY_FIELD, VOUCH_DOMAIN_NAME_FIELD, VOUCH_MESSAGE_FIELD, VOUCH_TRANSIENT_KEY_BOX_FIELD, VerifyPassword, VerifyPasswordClass, a, b64decode, b64encode, br, button, bytesToSize, concatBuffers, credentialsToSecretKey, decodeUTF8, decryptMessage, disturbePb, div, encodeUTF8, encryptMessage, form, h1, h2, h3, h4, h5, h6, hr, i, img, input, label, li, option, p, scrypt, select, sendHello, sendInitiate, sendMessage, small, span, strong, textarea, toHex, ul, validPublicKey, _ref, _ref1;
  ...
  $(function() {
    $('#loader').hide();
    return React.render(DisturbeApp(), document.getElementById('app'));
  });
